...
\@writefile{lof}{\contentsline {figure}{\numberline {4.1}{\ignorespaces Demonstrating how $T$-score is measured.\relax }}{18}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {4.3}{\ignorespaces An example of calculating the maximum number of visits given a thread. \relax }}{21}}
...
\@writefile{lof}{\contentsline {figure}{\numberline {A.1}{\ignorespaces Time distributions for $k = 4$\relax }}{A-4}}
...
\@writefile{lot}{\addvspace {10\p@ }}
\@writefile{lot}{\addvspace {10\p@ }}
\@writefile{lot}{\contentsline {table}{\numberline {1.1}{\ignorespaces Features of popular Web 2.0 sites\relax }}{2}}
\@writefile{lot}{\contentsline {table}{\numberline {3.1}{\ignorespaces Common notation used throughout this thesis\relax }}{11}}
\@writefile{lot}{\contentsline {table}{\numberline {4.1}{\ignorespaces Notation used for evaluation metrics\relax }}{18}}
\@writefile{lot}{\contentsline {table}{\numberline {5.1}{\ignorespaces Experiment results: Varying vocabulary size\relax }}{25}}
\@writefile{lot}{\contentsline {table}{\numberline {5.2}{\ignorespaces Results for tuning parameters using only $\mathbf  {t}_\Delta $\relax }}{25}}
\@writefile{lot}{\contentsline {table}{\numberline {5.3}{\ignorespaces Results for tuning parameters using only $\mathbf  {v}$\relax }}{26}}
\@writefile{lot}{\contentsline {table}{\numberline {5.4}{\ignorespaces Results for tuning parameters using $\mathbf  {t}_\Delta + \mathbf  {v}+ \mathbf  {t}_\text  {ctx}$\relax }}{26}}
\@writefile{lot}{\contentsline {table}{\numberline {5.5}{\ignorespaces Results for tuning $\alpha $ for the \texttt  {DEC} method\relax }}{27}}
\@writefile{lot}{\contentsline {table}{\numberline {5.6}{\ignorespaces Results for tuning $\eta $ for the \texttt  {SGD} method\relax }}{28}}
\@writefile{lot}{\contentsline {table}{\numberline {5.7}{\ignorespaces Full evaluation using 830 threads\relax }}{28}}
\@writefile{lot}{\contentsline {table}{\numberline {5.8}{\ignorespaces Paired difference evaluation results\relax }}{29}}
\@writefile{lot}{\contentsline {table}{\numberline {5.9}{\ignorespaces Breakdown of evaluation results\relax }}{30}}
...
\@writefile{toc}{\contentsline {section}{\numberline {2.3}Evaluation metrics}{8}}
\@writefile{toc}{\contentsline {section}{\numberline {2.4}Conclusion}{9}}
\@writefile{toc}{\contentsline {section}{\numberline {3.1}Baselines}{11}}
...
\@writefile{toc}{\contentsline {subsection}{\numberline {A.2.1}Data: avsforum.com}{A-2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {A.2.2}Latent Dirichlet Allocation}{A-2}}
\@writefile{toc}{\contentsline {subsection}{\numberline {A.2.3}Distribution of $\Delta _t$}{A-3}}
\@writefile{toc}{\contentsline {subsubsection}{Decay factor}{26}}
\@writefile{toc}{\contentsline {subsubsection}{Different thread lengths}{29}}
\@writefile{toc}{\contentsline {subsubsection}{Learning rate for Stochastic Gradient Descent}{27}}
\@writefile{toc}{\contentsline {subsubsection}{Vocabulary size}{24}}
\@writefile{toc}{\contentsline {subsubsection}{Window size}{25}}
\bibdata{report}
\bibstyle{socreport}
\citation{Brian2000}
\citation{Cao2003}
